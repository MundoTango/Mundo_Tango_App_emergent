...
router.get('/api/admin/subscription/feature-flags', async (req: Request, res: Response) => {
  try {
    const mappings = [];
...
router.put('/api/admin/subscription/feature-mapping', async (req: Request, res: Response) => {
  try {
...
router.get('/api/admin/subscription/analytics', async (req: Request, res: Response) => {
  try {
...
router.get('/api/user/subscription-features', async (req: Request, res: Response) => {
  try {
