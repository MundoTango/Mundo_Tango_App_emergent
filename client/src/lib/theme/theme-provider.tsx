...
export const themes: Record<string, ThemeConfig> = {
  ...
  'zen-minimal': {
    ...
    preview: 'linear-gradient(135deg, var(--color-neutral-0), #f3f4f6)',
  },
  'agent-health': {
    id: 'agent-health',
    name: 'Health Agent',
  ...
  'high-contrast': {
    ...
    tokens: {
      ...
      colors: {
        ...
        primary: {
          ...
          100: 'var(--color-neutral-0)',
          200: 'var(--color-neutral-0)',
          300: 'var(--color-neutral-0)',
          400: 'var(--color-neutral-0)',
          500: 'hsl(0, 0%, 0%)',
          600: 'hsl(0, 0%, 0%)',
          700: 'hsl(0, 0%, 0%)',
          800: 'hsl(0, 0%, 0%)',
    ...
    preview: 'linear-gradient(135deg, var(--color-neutral-0), hsl(0, 0%, 0%))',
  },
};
