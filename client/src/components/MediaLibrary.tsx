                      ...
                      <div className="p-4 bg-white dark:bg-gray-800 rounded-b-xl border-t border-gray-100 dark:border-gray-700">
                        ...
                        <div className="mb-3">
                          ...
                          <input
                            ...
                            onChange={(e) = data-testid="input-element"> updateMediaMetadata(media.id, { caption: e.target.value })}
                        ...
                        <div className="flex items-center gap-2">
                          ...
                          <input
                            ...
                            onChange={(e) = data-testid="input-element"> updateMediaMetadata(media.id, { sortOrder: parseInt(e.target.value) || 0 })}
                            onClick={(e) => e.stopPropagation()}
