              ...
              {consentTypes.map((type) => (
                <div key={type.type} className="flex items-center justify-between p-4 border rounded-lg">
                  <div className="flex-1">
                    ...
                    <p className="text-sm text-gray-600 mb-2 dark:text-neutral-600 dark:text-neutral-400">{type.description}</p>
            ...
            <CardContent className="space-y-4">
              <div className="grid gap-4 md:grid-cols-2">
                <Card className="p-4">
                  ...
                  <p className="text-sm text-gray-600 mb-3 dark:text-neutral-600 dark:text-neutral-400">
