    ...
    <div className={`space-y-4 ${className}`}>
      ...
      <div className="relative">
        ...
        <Input
          ...
          required={required}
          className="pl-10 pr-10 py-3 w-full border-gray-200 focus:border-pink-300 focus:ring-pink-100 rounded-lg" data-testid="input-text" />
        ...
        <Button
          ...
          size="sm"
          onClick={handleClear}
          className="absolute right-2 top-1/2 transform -translate-y-1/2 text-gray-400 hover:text-gray-600" data-testid="button-button">
