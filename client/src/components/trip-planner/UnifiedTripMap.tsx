            ...
            <div class="p-3 min-w-[280px]">
              ...
              <div class="flex gap-2">
                <button data-action="view-details" data-id="${event.id}" data-type="event"
                  class="flex-1 bg-gradient-to-r from-cyan-500 to-blue-500 text-white px-3 py-1.5 rounded-lg text-sm hover:opacity-90 transition" data-testid="button-element">
                  View Details
                </button>
                ${onAddToItinerary ? `
                  <button data-action="add-itinerary" data-id="${event.id}" data-type="event"
                    class="flex-1 bg-white dark:bg-gray-800 border border-ocean-500 text-cyan-600 dark:text-cyan-400 px-3 py-1.5 rounded-lg text-sm hover:bg-cyan-50 dark:hover:bg-cyan-900/20 transition" data-testid="button-element">
                    Add to Trip
                  </button>
                ` : ''}
              </div>
            ...
            <div class="p-3 min-w-[280px]">
              ...
              <div class="flex gap-2">
                <button data-action="view-details" data-id="${home.id}" data-type="housing"
                  class="flex-1 bg-gradient-to-r from-turquoise-500 to-cyan-500 text-white px-3 py-1.5 rounded-lg text-sm hover:opacity-90 transition" data-testid="button-element">
                  View Details
                </button>
                ${onAddToItinerary ? `
                  <button data-action="add-itinerary" data-id="${home.id}" data-type="housing"
                    class="flex-1 bg-white dark:bg-gray-800 border border-turquoise-500 text-turquoise-600 dark:text-turquoise-400 px-3 py-1.5 rounded-lg text-sm hover:bg-turquoise-50 dark:hover:bg-turquoise-900/20 transition" data-testid="button-element">
                    Add to Trip
                  </button>
                ` : ''}
              </div>
            ...
            <div class="p-3 min-w-[280px]">
              ...
              <div class="flex gap-2">
                <button data-action="view-details" data-id="${rec.id}" data-type="recommendation"
                  class="flex-1 bg-gradient-to-r from-pink-500 to-purple-500 text-white px-3 py-1.5 rounded-lg text-sm hover:opacity-90 transition" data-testid="button-element">
                  View Details
                </button>
                ${onAddToItinerary ? `
                  <button data-action="add-itinerary" data-id="${rec.id}" data-type="recommendation"
                    class="flex-1 bg-white dark:bg-gray-800 border border-pink-500 text-pink-600 dark:text-pink-400 px-3 py-1.5 rounded-lg text-sm hover:bg-pink-50 dark:hover:bg-pink-900/20 transition" data-testid="button-element">
                    Add to Trip
                  </button>
                ` : ''}
              </div>
