...
export default function Navbar({ onMenuClick }: NavbarProps) {
  ...
  return (
    <div className="bg-white dark:bg-gray-900 h-16 border-b-2 border-gray-200 dark:border-gray-700 transition-all flex items-center gap-3 p-3 md:p-5 select-none">
      <div>
        <Button
          variant="ghost"
          size="icon"
      ...
      <div className="flex-1 relative">
        <div className="relative">
          ...
          <Input
            ...
            className="pl-10 bg-gray-50 dark:bg-gray-800 border-gray-300 rounded-lg"
            value={searchQuery}
            onChange={(e) => setSearchQuery(e.target.value)}
          />
          {searchQuery && (
            <div className="absolute w-full max-h-96 overflow-y-auto left-0 top-full mt-1 bg-white dark:bg-gray-900 rounded-lg border border-gray-200 dark:border-gray-700 shadow-lg z-50">
