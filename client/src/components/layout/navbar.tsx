...
export default function Navbar({ onMenuClick }: NavbarProps) {
  ...
  return (
    <div className="bg-white h-16 border-b-2 border-gray-200 transition-all flex items-center gap-3 p-3 md:p-5 select-none dark:bg-neutral-900">
      <div>
        <Button
          variant="ghost"
          size="icon"
          ...
          {searchQuery && (
            <div className="absolute w-full max-h-96 overflow-y-auto left-0 top-full mt-1 bg-white rounded-lg border border-gray-200 shadow-lg z-50 dark:bg-neutral-900">
              <div className="grid grid-cols-4 gap-4 p-4">
                <div>
                  <h3 className="font-semibold text-sm text-gray-700 mb-2 dark:text-neutral-600 dark:text-neutral-300">Posts</h3>
                  <div className="space-y-2">
                    <div className="flex items-center gap-2 p-2 hover:bg-gray-50 rounded cursor-pointer dark:bg-neutral-800">
                ...
                <div>
                  <h3 className="font-semibold text-sm text-gray-700 mb-2 dark:text-neutral-600 dark:text-neutral-300">Groups</h3>
                  <div className="space-y-2">
                    <div className="flex items-center gap-2 p-2 hover:bg-gray-50 rounded cursor-pointer dark:bg-neutral-800">
                      <img src="/api/placeholder/32/32" className="w-8 h-8 rounded-full object-cover" />
                ...
                <div>
                  <h3 className="font-semibold text-sm text-gray-700 mb-2 dark:text-neutral-600 dark:text-neutral-300">Friends</h3>
                  <div className="space-y-2">
                    <div 
                      className="flex items-center gap-2 p-2 hover:bg-gray-50 rounded cursor-pointer dark:bg-neutral-800"
                      onClick={() => window.location.href = '/profile/1'}
                     role="button" tabIndex={0} onKeyDown={(e) => { if (e.key === 'Enter' || e.key === ' ') { e.preventDefault(); () => window.location.href = '/profile/1'(e); } }}>
                      <img src="/api/placeholder/32/32" className="w-8 h-8 rounded-full object-cover" />
                ...
                <div>
                  <h3 className="font-semibold text-sm text-gray-700 mb-2 dark:text-neutral-600 dark:text-neutral-300">Events</h3>
                  <div className="space-y-2">
                    <div className="flex items-center gap-2 p-2 hover:bg-gray-50 rounded cursor-pointer dark:bg-neutral-800">
                      <img src="/api/placeholder/32/32" className="w-8 h-8 rounded-full object-cover" />
        ...
        <DropdownMenu>
          <DropdownMenuTrigger asChild>
            <div className="cursor-pointer pl-2 md:pl-0 flex items-center gap-2">
              ...
              <div className="p-2">
                <ChevronDown className="h-4 w-4 text-gray-600 dark:text-neutral-600 dark:text-neutral-400" />
              </div>
            </div>
          </DropdownMenuTrigger>
          <DropdownMenuContent className="w-56" align="end" forceMount>
            <DropdownMenuItem className="font-semibold text-gray-700 px-3 py-3 dark:text-neutral-600 dark:text-neutral-300">
              Change Password
            </DropdownMenuItem>
            <DropdownMenuItem className="font-semibold text-gray-700 px-3 py-3 dark:text-neutral-600 dark:text-neutral-300">
              FAQs
