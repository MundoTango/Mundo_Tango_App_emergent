          ...
          {searchQuery && (
            <div className="absolute w-full max-h-96 overflow-y-auto left-0 top-full mt-1 bg-white rounded-lg border border-gray-200 shadow-lg z-50 dark:bg-neutral-900">
              <div className="grid grid-cols-4 gap-4 p-4">
                <div>
                  <h3 className="font-semibold text-sm text-gray-700 mb-2 dark:text-neutral-300">Posts</h3>
                ...
                <div>
                  <h3 className="font-semibold text-sm text-gray-700 mb-2 dark:text-neutral-300">Groups</h3>
                  <div className="space-y-2">
                    <div className="flex items-center gap-2 p-2 hover:bg-gray-50 rounded cursor-pointer dark:bg-neutral-800">
                      <img src="/api/placeholder/32/32" className="w-8 h-8 rounded-full object-cover" />
                ...
                <div>
                  <h3 className="font-semibold text-sm text-gray-700 mb-2 dark:text-neutral-300">Friends</h3>
                  <div className="space-y-2">
                    <div 
                ...
                <div>
                  <h3 className="font-semibold text-sm text-gray-700 mb-2 dark:text-neutral-300">Events</h3>
                  <div className="space-y-2">
                    <div className="flex items-center gap-2 p-2 hover:bg-gray-50 rounded cursor-pointer dark:bg-neutral-800">
                      <img src="/api/placeholder/32/32" className="w-8 h-8 rounded-full object-cover" />
      ...
      <div className="mr-1 md:mr-4 flex items-center md:space-x-5">
          ...
          <div>
            <Button variant="ghost" size="icon" asChild data-testid="button-element">
              <Link href="/messages" data-testid="link-element">
                <MessageCircle className="h-5 w-5 text-gray-600 dark:text-neutral-400" />
              </Link>
            </Button>
          </div>
        ...
        <DropdownMenu>
          ...
          <DropdownMenuContent className="w-56" align="end" forceMount>
            <DropdownMenuItem className="font-semibold text-gray-700 px-3 py-3 dark:text-neutral-300">
              Change Password
            </DropdownMenuItem>
            <DropdownMenuItem className="font-semibold text-gray-700 px-3 py-3 dark:text-neutral-300">
              FAQs
