  ...
  return (
    <div className="space-y-8">
      <div>
        ...
        <p className="text-gray-600 dark:text-gray-300">Share some basic info about your property</p>
      </div>
      ...
      <div className="space-y-4">
        <div>
          ...
          <p className="text-xs text-gray-500 dark:text-gray-400 mt-1">{data.title?.length || 0}/255 characters</p>
        </div>
        ...
        <div>
          ...
          <p className="text-xs text-gray-500 dark:text-gray-400 mt-1">{data.description?.length || 0}/1000 characters</p>
        </div>
      </div>
      ...
      <div>
        ...
        <div className="space-y-4">
          ...
          map((item) =>
          <div key={item.field} className="bg-[var(--color-surface-elevated)] p-4 rounded-lg">
              <div className="flex items-center justify-between">
