    ...
    return (
      <div className={`relative ${className}`}>
        <button
          ...
          className="flex items-center space-x-1 px-3 py-2 text-gray-600 hover:text-gray-800 transition-colors" data-testid="button-flex">
        ...
        <div className="absolute top-full left-0 mt-2 bg-white rounded-lg shadow-lg border border-gray-200 p-4 z-50 min-w-64">
            ...
            <div className="border-t border-gray-200 pt-3">
              <div className="flex items-center space-x-2">
                ...
                value={shareUrl}
                readOnly
                className="flex-1 px-3 py-2 bg-gray-50 border border-gray-200 rounded-lg text-sm text-gray-600" data-testid="input-text" />

                <button
                onClick={copyToClipboard}
                className="flex items-center space-x-1 px-3 py-2 bg-pink-600 text-white rounded-lg hover:bg-pink-700 transition-colors" data-testid="button-flex">
  ...
  return (
    <div className={`flex items-center space-x-2 ${className}`}>
      ...
      <button
        ...
        title="Copy link" data-testid="button-group">
