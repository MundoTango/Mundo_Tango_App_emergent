...
export default function EnhancedPostCreator({ 
      ...
      <GlassCard depth={1} className="rounded-xl shadow-lg border border-white/20 p-4 mb-6"
        <div className="flex items-center space-x-3">
          ...
          <div className="flex space-x-2">
            <button className="p-2 hover:bg-pink-100 rounded-full transition-colors duration-200 text-pink-600" data-testid="button-p-2">
              <Camera className="w-5 h-5" />
            </button>
            <button className="p-2 hover:bg-blue-100 rounded-full transition-colors duration-200 text-blue-600" data-testid="button-p-2">
              <Video className="w-5 h-5" />
            </button>
            <button className="p-2 hover:bg-green-100 rounded-full transition-colors duration-200 text-green-600" data-testid="button-p-2">
  ...
  return (
    <GlassCard depth={1} className="fixed inset-0 flex items-center justify-center z-[100] p-4"
      <div className="bg-white rounded-2xl shadow-2xl w-full max-w-2xl max-h-[90vh] overflow-hidden dark:bg-neutral-900">
        {/* Header */}
        ...
        <div className="p-6 max-h-[calc(90vh-140px)] overflow-y-auto">
          ...
          <div className="flex items-center space-x-3 mb-4">
            ...
            <div>
              <p className="font-semibold text-gray-900 dark:text-neutral-100">{user?.name || 'User'}</p>
          ...
          {/* Emoji picker */}
          {showEmojiPicker && (
            <div className="mt-4 p-4 bg-gray-50 rounded-lg border dark:bg-neutral-800">
        ...
        {/* Footer actions */}
        <div className="flex items-center justify-between p-6 border-t border-gray-100 bg-gray-50 dark:bg-neutral-800">
          <div className="flex items-center space-x-3">
            <input
              ref={fileInputRef}
              type="file"
