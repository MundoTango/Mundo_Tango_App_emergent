...
export default function AgentOrchestrationPanel({ className }: AgentOrchestrationPanelProps) {
  ...
  return (
    <Card className={`p-4 bg-black/40 backdrop-blur-md border-cyan-500/30 ${className}`}>
      <div className="space-y-4">
        ...
        <div className="space-y-2">
          <div className="flex items-center justify-between text-xs">
            <span className="text-gray-400">MB.MD Progress</span>
          ...
          <div className="grid grid-cols-4 gap-1 mt-2">
            {mbmdPhases.map((phase) => (
              ...
              >
                ...
                <div className="text-xs text-gray-400">{phase.progress}%</div>
              </div>
            ))}
          </div>
        </div>
        ...
        {/* Active Agents */}
        <div className="space-y-2">
          <div className="text-xs font-medium text-gray-400 uppercase">Active Agents</div>
