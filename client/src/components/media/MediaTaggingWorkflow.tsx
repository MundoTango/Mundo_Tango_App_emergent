        ...
        <CardContent className="space-y-4">
          <div className="flex gap-2">
            <Input
              ...
              value={searchTag}
              onChange={(e) = data-testid="input-element"> setSearchTag(e.target.value)}
              onKeyPress={(e) => {
            ...
            />
            <Button
              onClick={() = data-testid="button-element"> searchTag.trim() && addTagFilter(searchTag.trim().toLowerCase())}
            ...
            <Card key={media.id} className="group hover:shadow-lg transition-shadow">
              <div className="relative aspect-video bg-muted rounded-t-lg overflow-hidden">
                ...
                {onMediaSelect && (
                  <Button
                    ...
                    onClick={() = data-testid="button-absolute"> onMediaSelect(media)}
                  >
                    Select
                  </Button>
                )}
              ...
              <CardContent className="p-4 space-y-3">
                ...
                <div className="flex gap-2">
                  ...
                  <Button
                    size="sm"
                    onClick={() = data-testid="button-element"> handleAddTag(media.id, newTag)}
