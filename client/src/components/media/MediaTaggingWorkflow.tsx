        ...
        <CardContent className="space-y-4">
          <div className="flex gap-2">
            ...
            <Button
              ...
              disabled={!searchTag.trim()} data-testid="button-element">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
        ...
        <Card key={media.id} className="group hover:shadow-lg transition-shadow">
            ...
            <Button
              ...
              onClick={() => onMediaSelect(media)} data-testid="button-absolute">
            ...
            <div className="flex flex-wrap gap-1">
              ...
              <Badge key={tag} variant="secondary" className="text-xs flex items-center gap-1">
                ...
                className="text-sm" data-testid="input-text-sm" />

                  <Button
                size="sm"
                onClick={() => handleAddTag(media.id, newTag)}
                disabled={!newTag.trim() || addTagMutation.isPending} data-testid="button-element">
