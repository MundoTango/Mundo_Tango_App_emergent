      ...
      <div className="relative bg-white dark:bg-gray-900 rounded-2xl shadow-lg overflow-hidden hover:shadow-2xl transition-all duration-300 cursor-pointer group">
        ...
        <div className="relative h-56 overflow-hidden">
          {displayImage ? (
            ...
            <div className="w-full h-full bg-gradient-to-br from-pink-500 via-purple-500 dark:via-purple-600 to-blue-500">
          ...
          <div className="pt-4 border-t border-gray-100">
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-2 text-sm text-gray-600">
                ...
                <span>{t('common.active_tango_community')}</span>
              </div>
              <ArrowRight className="h-5 w-5 text-gray-400 dark:text-gray-500 group-hover:text-purple-600 group-hover:translate-x-1 transition-all" />
            </div>
          </div>
