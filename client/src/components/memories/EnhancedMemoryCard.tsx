        ...
        <div className="border-t border-gray-100 p-4 space-y-4">
            ...
            <div className="flex gap-2">
              ...
              <div className="flex-1 flex gap-2">
                ...
                }} data-testid="textarea-flex-1" />

                <Button
                size="sm"
                onClick={handleComment}
                disabled={!commentText.trim() || commentMutation.isPending} data-testid="button-element">
        ...
        <DialogContent>
          ...
          <div className="space-y-4">
            <Textarea
              ...
              className="min-h-[100px]" data-testid="textarea-min-h-100px" />
            ...
            <div className="flex justify-end gap-2">
              <Button variant="outline" onClick={() => setShowShareDialog(false)} data-testid="button-element">
                Cancel
              </Button>
