        ...
        <CardHeader>
          <div className="flex items-center justify-between">
            ...
            <Button
              ...
              disabled={isChecking}
              className="bg-gradient-to-r from-turquoise-500 to-cyan-600" data-testid="button-bg-gradient-to-r">
                  ...
                  result.passed ? 'border-green-200 bg-green-50/50' : 'border-red-200 bg-red-50/50'}`
                      ...
                      <CardContent className="p-4">
                        ...
                        <Button
                          ...
                          className="bg-gradient-to-r from-blue-500 to-purple-600" data-testid="button-bg-gradient-to-r">
