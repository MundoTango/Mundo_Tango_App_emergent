      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
        <Card className="glassmorphic-card hover:shadow-lg transition-shadow">
          ...
          <CardContent>
            ...
            <p className="text-sm text-gray-600 dark:text-neutral-400">New Patterns</p>
          </CardContent>
        </Card>
        ...
        <Card className="glassmorphic-card hover:shadow-lg transition-shadow">
          ...
          <CardContent>
            ...
            <p className="text-sm text-gray-600 dark:text-neutral-400">Performance Gain</p>
          </CardContent>
        </Card>
        ...
        <Card className="glassmorphic-card hover:shadow-lg transition-shadow">
          ...
          <CardContent>
            ...
            <p className="text-sm text-gray-600 dark:text-neutral-400">Issues Resolved</p>
          </CardContent>
        </Card>
      </div>
          ...
          return (
            <Card key={learning.id} className="glassmorphic-card hover:shadow-xl transition-all">
              ...
              <CardContent className="space-y-4">
                <p className="text-sm text-gray-600 dark:text-neutral-400">{learning.description}</p>
                
                <div className="bg-gray-50 rounded-lg p-3 dark:bg-neutral-800">
                  <p className="text-xs font-semibold text-gray-700 mb-1 dark:text-neutral-300">Pattern:</p>
                  <Code className="w-4 h-4 inline mr-1 text-gray-500" />
                  <code className="text-xs text-gray-600 dark:text-neutral-400">{learning.pattern}</code>
                </div>

                <div>
                  <p className="text-xs font-semibold text-gray-700 mb-2 dark:text-neutral-300">Applied Solutions:</p>
                  <ul className="space-y-1">
                    {learning.examples.map((example, idx) => (
                      <li key={idx} className="text-xs text-gray-600 flex items-center gap-1 dark:text-neutral-400">
