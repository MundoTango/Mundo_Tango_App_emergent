      ...
      {isOpen && (
        ...
        >
          ...
          <motion.div
            ...
            className="relative w-full max-w-md bg-white dark:bg-gray-900/10 backdrop-blur-xl rounded-3xl shadow-2xl border border-white/20 p-6"
            style={{
          ...
          >
            ...
            <div className="flex gap-3">
              <button
                onClick={onClose}
                disabled={isDeleting}
                className="flex-1 px-4 py-3 bg-white dark:bg-gray-900/10 hover:bg-white/20 text-white rounded-xl transition-colors disabled:opacity-50"
