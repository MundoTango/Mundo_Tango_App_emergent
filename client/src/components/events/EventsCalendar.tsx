        ...
        <div className="flex justify-between items-center mb-4">
          ...
          <div className="flex gap-2">
            <Button
              ...
              className={view === 'month' ? 'bg-gradient-to-r from-turquoise-500 to-cyan-600' : ''} data-testid="button-element">
            ...
            <Button
              ...
              className={view === 'week' ? 'bg-gradient-to-r from-turquoise-500 to-cyan-600' : ''} data-testid="button-element">
            ...
            <Button
              ...
              onClick={() => setView('day')}
              className={view === 'day' ? 'bg-gradient-to-r from-turquoise-500 to-cyan-600' : ''} data-testid="button-element">
