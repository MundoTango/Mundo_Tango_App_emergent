          ...
          <Dialog open={showAddDialog} onOpenChange={setShowAddDialog}>
            ...
            <DialogContent className="glassmorphic-card max-w-md">
              ...
              <div className="space-y-4 mt-4">
                ...
                <div>
                  <Label>Role</Label>
                  <Select value={selectedRole} onValueChange={(value: 'admin' | 'moderator') => setSelectedRole(value)} data-testid="select-element">
                ...
                <div className="space-y-2 max-h-60 overflow-y-auto">
                  ...
                  <div key={user.id} className="flex items-center justify-between p-3 rounded-lg hover:bg-[var(--color-surface-elevated)]">
                      ...
                      disabled={addAdminMutation.isPending} data-testid="button-element">
