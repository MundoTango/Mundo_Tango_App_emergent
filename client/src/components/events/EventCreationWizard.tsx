  ...
  const renderSettings = () => (
    <div className="space-y-4">
      ...
      <div>
        ...
        >
          <SelectTrigger className="bg-white dark:bg-gray-900/50 border-white/30">
            <SelectValue />
          </SelectTrigger>
          <SelectContent>
          ...
          <div>
            ...
            <div className="flex items-center gap-2">
              <Input
                ...
                className="w-20 bg-white dark:bg-gray-900/50 border-white/30"
              />
    ...
    <Card className="w-full max-w-2xl mx-auto bg-gradient-to-br from-white/90 via-white/80 to-turquoise-50/30 backdrop-blur-xl border border-white/20 shadow-xl">
      ...
      <form onSubmit={handleSubmit(onSubmit)}>
        <CardContent className="space-y-6">
          ...
          {/* Navigation Buttons */}
          <div className="flex justify-between pt-6 border-t border-gray-200 dark:border-gray-700/50">
            <div className="flex gap-2">
              {currentStep > 0 && (
                <Button
                  type="button"
