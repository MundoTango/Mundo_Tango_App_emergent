...
export default function MemoryCardFixed({ post }: MemoryCardProps) {
  ...
  return (
    <article className="bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden hover:shadow-md transition-shadow dark:bg-neutral-900" data-testid="link-bg-white">
      {/* Header */}
      <div className="p-4">
