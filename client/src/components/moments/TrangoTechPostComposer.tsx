        ...
        <div className="flex items-center gap-4">
          ...
          <button
            ...
            className="flex-1 text-left px-6 py-4 bg-white/80 backdrop-blur-sm rounded-xl 
                       ...
                       focus:outline-none focus:ring-2 focus:ring-coral-300 dark:bg-neutral-900"
          >
        ...
        <div className="flex items-center justify-between mt-4 pt-4 border-t border-coral-200/40">
          <div className="flex gap-4">
            <button className="flex items-center gap-2 px-4 py-2 bg-white/80 hover:bg-pink-50 
                             ...
                             hover:scale-105 hover:shadow-md transform duration-300 dark:bg-neutral-900" data-testid="button-flex">
            ...
            <div className="p-6">
              <div className="flex items-center justify-between mb-6">
                ...
                <button
                  ...
                  className="p-2 hover:bg-gray-100 rounded-full dark:bg-neutral-800"
                >
                  <X className="h-5 w-5" />
                </button>
              </div>
              ...
              <div className="space-y-4">
                <textarea
                  ...
                  onChange={(e) = data-testid="textarea-element"> setNewPost(prev => ({ ...prev, content: e.target.value }))}
                ...
                <div className="flex items-center gap-2 p-3 border rounded-lg">
                  ...
                  <input
                    ...
                    onChange={(e) = data-testid="input-element"> setNewPost(prev => ({ ...prev, location: e.target.value }))}
                ...
                <div className="space-y-3">
                  <div className="flex gap-3">
                    <label className="flex items-center gap-2 px-4 py-2 bg-white/80 hover:bg-pink-50 border border-pink-200 rounded-lg cursor-pointer transition-colors dark:bg-neutral-900">
                    ...
                    <label className="flex items-center gap-2 px-4 py-2 bg-white/80 hover:bg-blue-50 border border-blue-200 rounded-lg cursor-pointer transition-colors dark:bg-neutral-900">
                      <Video className="h-4 w-4 text-blue-600" />
                    ...
                    {newPost.imageUrl && (
                      <div className="relative">
                        ...
                        />
                        <button
                          onClick={() = data-testid="button-element"> setNewPost(prev => ({ ...prev, imageUrl: null }))}
                    ...
                    {newPost.videoUrl && (
                      <div className="relative">
                        ...
                        />
                        <button
                          onClick={() = data-testid="button-element"> setNewPost(prev => ({ ...prev, videoUrl: null }))}
                          className="absolute top-2 right-2 p-1 bg-black/50 text-white rounded-full hover:bg-black/70"
                        >
                          <X className="h-4 w-4" />
                        </button>
                  ...
                  <div className="flex items-center justify-between pt-4 border-t">
                    <div className="flex items-center gap-2">
                      ...
                      <div className="flex gap-1">
                        {['Public', 'Friends', 'Private'].map((vis) => (
                          <button
                            key={vis}
                            onClick={() = data-testid="button-element"> setNewPost(prev => ({ ...prev, visibility: vis.toLowerCase() }))}
                    ...
                    <div className="flex gap-2">
                      <button
                        onClick={() = data-testid="button-element"> setShowExpandedComposer(false)}
                        className="px-6 py-2 text-gray-600 hover:bg-gray-100 rounded-lg transition-colors dark:bg-neutral-800"
                      >
                        Cancel
                      </button>
                      <button
