    ...
    <div className={`space-y-6 ${className}`}>
      ...
      {(showFilters || showSearch) && (
        <div className="relative group bg-white/60 backdrop-blur-sm rounded-3xl p-6 border border-gray-200/50 shadow-lg">
          ...
          <div className="absolute inset-0 bg-gradient-to-br from-teal-500/95 to-cyan-600/95 rounded-3xl cursor-not-allowed z-10 pointer-events-auto backdrop-blur-md shadow-inner">
            <span className="absolute inset-0 flex items-center justify-center text-2xl font-bold text-white opacity-0 group-hover:opacity-100 transition-opacity duration-200 drop-shadow-lg">
              COMING SOON
            </span>
          </div>
        </div>
