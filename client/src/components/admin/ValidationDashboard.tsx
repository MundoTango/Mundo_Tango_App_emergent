      ...
      <div className="bg-gradient-to-r from-turquoise-50 via-cyan-50 to-blue-50 p-6 rounded-lg">
        ...
        <div className="flex gap-4 mt-4">
          ...
          <Button
            ...
            variant="outline"
            disabled={isRunning} data-testid="button-element">
          ...
          <Button
            ...
            variant="outline"
            disabled={Object.keys(results).length === 0} data-testid="button-element">
      ...
      <Card className="p-6">
        ...
        <div className="grid grid-cols-4 gap-4">
          <div className="text-center">
            <p className="text-2xl font-bold text-[var(--color-primary-hover)]">{performanceMetrics.totalTests}</p>
      ...
      <div className="grid grid-cols-3 gap-4">
        <Card className="p-4">
          <div className="flex items-center gap-2">
            ...
            <div>
              <p className="text-sm text-gray-600 dark:text-gray-300">Render Performance</p>
        ...
        <Card className="p-4">
          <div className="flex items-center gap-2">
            ...
            <div>
              <p className="text-sm text-gray-600 dark:text-gray-300">Security Status</p>
                ...
                return (
                  <div key={test.id} className="flex items-center justify-between p-3 border rounded-lg">
                      <div className="flex items-center gap-3">
                        ...
                        {result.status === 'pending' && <div className="h-5 w-5 rounded-full border-2 border-gray-300 dark:border-gray-600" />}
