    ...
    <div className="fixed bottom-4 right-4 z-50">
      {!isExpanded ? (
        ...
        <button
          ...
          className="bg-white dark:bg-gray-900 dark:bg-gray-800 rounded-full p-3 shadow-lg border border-gray-200 dark:border-gray-700 dark:border-gray-700 hover:shadow-xl transition-all duration-200 group"
          title="Change Theme"
        >
        ...
        <div className="bg-white dark:bg-gray-900 dark:bg-gray-800 rounded-2xl shadow-2xl border border-gray-200 dark:border-gray-700 dark:border-gray-700 p-6 w-80 max-h-96 overflow-y-auto">
          {/* Header */}
          ...
          <div className="mb-4 p-3 rounded-lg border border-gray-200 dark:border-gray-700 dark:border-gray-600">
                ...
                {themes.map((theme) => (
                  ...
                  >
                    <div className="flex items-center gap-2 mb-1">
                      ...
                      />
                      <span className="text-sm font-medium text-gray-900 dark:text-white dark:text-white truncate">
                        {theme.name}
                      </span>
                    </div>
          ...
          {/* Quick Actions */}
          <div className="border-t border-gray-200 dark:border-gray-700 dark:border-gray-600 pt-4">
