  ...
  return (
    <div className="fixed bottom-4 right-4 z-50">
      ...
      <button
        ...
        title="Change Theme" data-testid="button-bg-white">
        ...
        <div key={category} className="mb-4">
          ...
          <div className="border-t border-gray-200 dark:border-gray-600 pt-4">
            <div className="flex gap-2">
              ...
              className="flex-1 px-3 py-2 text-sm bg-gradient-to-r from-pink-500 to-blue-500 text-white rounded-lg hover:from-pink-600 hover:to-blue-600 transition-all" data-testid="button-flex-1">
