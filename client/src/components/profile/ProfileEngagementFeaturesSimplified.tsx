      ...
      component: (
        <div className="space-y-3">
          {[
            ...
            <div 
              key={challenge.name}
              className="p-4 bg-white dark:bg-gray-900/70 rounded-lg border border-gray-200 dark:border-gray-700 hover:border-turquoise-300 transition-colors cursor-pointer"
      ...
      component: (
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          {[
            ...
            <div key={streak.name} className="text-center p-4 bg-white dark:bg-gray-900/50 rounded-lg border border-gray-200 dark:border-gray-700">
