        ...
        <CardContent>
          <div className="grid grid-cols-2 gap-4">
            ...
            metrics.prelaunchTestsComplete ? 'bg-green-50' : 'bg-yellow-50'}`
              ...
              <div className="text-sm text-gray-600 dark:text-gray-300">All 245 tests passing</div>
            </div>
            <div className={`p-4 rounded-lg ${
            metrics.rollbackPlanReady ? 'bg-green-50' : 'bg-yellow-50'}`
              ...
              <div className="text-sm text-gray-600 dark:text-gray-300">Tested and documented</div>
            </div>
            <div className="p-4 bg-green-50 rounded-lg">
              ...
              <div className="text-sm text-gray-600 dark:text-gray-300">Sub-100ms response time</div>
            </div>
            <div className="p-4 bg-green-50 rounded-lg">
              <div className="flex items-center justify-between mb-2">
              ...
              <div className="text-sm text-gray-600 dark:text-gray-300">No vulnerabilities found</div>
            </div>
          </div>
        </CardContent>
      </Card>
