        ...
        <CardContent>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div className="space-y-2">
              ...
              <div className="flex items-center justify-between">
                <span className="text-sm text-gray-600 dark:text-gray-300">CSP Violations</span>
                <span className="font-medium">{securityMetrics.cspViolations}</span>
              </div>
              <div className="flex items-center justify-between">
                <span className="text-sm text-gray-600 dark:text-gray-300">XSS Attempts Blocked</span>
                <span className="font-medium">{securityMetrics.xssAttempts}</span>
              </div>
            </div>
            <div className="space-y-2">
              <div className="flex items-center justify-between">
                <span className="text-sm text-gray-600 dark:text-gray-300">SQL Injection Blocked</span>
                <span className="font-medium">{securityMetrics.sqlInjectionAttempts}</span>
              </div>
              <div className="flex items-center justify-between">
                <span className="text-sm text-gray-600 dark:text-gray-300">Rate Limit Hits</span>
                <span className="font-medium">{securityMetrics.rateLimitHits}</span>
              </div>
              <div className="flex items-center justify-between">
                <span className="text-sm text-gray-600 dark:text-gray-300">Last Security Scan</span>
