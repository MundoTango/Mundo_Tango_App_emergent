          ...
          <div className="space-y-3">
            {pipelineStages.map((stage, index) => (
              <div key={index} className="flex items-center justify-between">
                ...
                <div className="flex items-center gap-3">
                  {stage.duration && (
                    <span className="text-sm text-gray-600 dark:text-neutral-600 dark:text-neutral-400">{stage.duration}s</span>
                  )}
        ...
        <CardContent>
          <div className="grid grid-cols-2 md:grid-cols-3 gap-4">
            <div className="text-center p-4 bg-gray-50 rounded-lg dark:bg-neutral-800">
              ...
              <div className="text-sm text-gray-600 dark:text-neutral-600 dark:text-neutral-400">Avg Build Time</div>
            </div>
            <div className="text-center p-4 bg-gray-50 rounded-lg dark:bg-neutral-800">
              <div className="text-2xl font-bold text-gray-800 dark:text-neutral-200">{metrics.deploymentFrequency}/week</div>
              <div className="text-sm text-gray-600 dark:text-neutral-600 dark:text-neutral-400">Deploy Frequency</div>
            </div>
            <div className="text-center p-4 bg-gray-50 rounded-lg dark:bg-neutral-800">
              <div className="text-2xl font-bold text-gray-800 dark:text-neutral-200">{metrics.coverage}%</div>
              <div className="text-sm text-gray-600 dark:text-neutral-600 dark:text-neutral-400">Code Coverage</div>
            </div>
          </div>
        </CardContent>
      </Card>
          ...
          <div className="space-y-4">
            ...
            <div className="grid grid-cols-3 gap-2 text-sm">
              ...
              <div className="text-center p-2 bg-gray-50 rounded dark:bg-neutral-800">
                <div className="font-bold text-gray-700 dark:text-neutral-600 dark:text-neutral-300">0</div>
                <div className="text-gray-600 dark:text-neutral-600 dark:text-neutral-400">Skipped</div>
              </div>
            </div>
          </div>
        </CardContent>
          ...
          <div className="space-y-3">
            <div className="flex items-center justify-between p-3 bg-gray-50 rounded-lg dark:bg-neutral-800">
              <div>
                ...
                <div className="text-sm text-gray-600 dark:text-neutral-600 dark:text-neutral-400">2 hours ago</div>
              </div>
            ...
            <div className="flex items-center justify-between p-3 bg-gray-50 rounded-lg dark:bg-neutral-800">
              <div>
                ...
                <div className="text-sm text-gray-600 dark:text-neutral-600 dark:text-neutral-400">4 hours ago</div>
              </div>
              <Badge className="bg-green-100 text-green-800">Success</Badge>
            </div>
            <div className="flex items-center justify-between p-3 bg-gray-50 rounded-lg dark:bg-neutral-800">
              <div>
                ...
                <div className="text-sm text-gray-600 dark:text-neutral-600 dark:text-neutral-400">6 hours ago</div>
              </div>
