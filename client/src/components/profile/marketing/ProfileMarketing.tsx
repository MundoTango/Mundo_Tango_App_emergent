        ...
        <CardContent>
          <div className="grid grid-cols-2 md:grid-cols-3 gap-4">
            <div className="text-center p-4 bg-white/70 rounded-lg dark:bg-neutral-900">
              ...
              <div className="text-sm text-gray-600 dark:text-neutral-400">Social Reach</div>
            </div>
            <div className="text-center p-4 bg-white/70 rounded-lg dark:bg-neutral-900">
              <Target className="w-8 h-8 text-purple-500 mx-auto mb-2" />
              <div className="text-2xl font-bold">{metrics.engagementRate}%</div>
              <div className="text-sm text-gray-600 dark:text-neutral-400">Engagement Rate</div>
            </div>
            <div className="text-center p-4 bg-white/70 rounded-lg dark:bg-neutral-900">
              <TrendingUp className="w-8 h-8 text-blue-500 mx-auto mb-2" />
              <div className="text-2xl font-bold">{metrics.conversionRate}%</div>
              <div className="text-sm text-gray-600 dark:text-neutral-400">Conversion Rate</div>
            </div>
          </div>
        </CardContent>
      </Card>
      ...
      <Card>
        ...
        <CardContent>
          ...
          <div className="grid grid-cols-2 gap-4 text-sm">
            <div>
              <div className="text-gray-600 dark:text-neutral-400">Profile Completeness</div>
              <div className="font-medium">95%</div>
            </div>
            <div>
              <div className="text-gray-600 dark:text-neutral-400">Content Quality</div>
              <div className="font-medium">88%</div>
            </div>
            <div>
              <div className="text-gray-600 dark:text-neutral-400">Audience Growth</div>
              <div className="font-medium">+12% monthly</div>
            </div>
            <div>
              <div className="text-gray-600 dark:text-neutral-400">Share Count</div>
            ...
            {campaigns.map((campaign, index) => (
              <div key={index} className="p-4 bg-gray-50 rounded-lg dark:bg-neutral-800">
                ...
                <div className="grid grid-cols-3 gap-2 text-sm">
                  <div>
                    <div className="text-gray-600 dark:text-neutral-400">Impressions</div>
                    <div className="font-medium">{campaign.impressions.toLocaleString()}</div>
                  </div>
                  <div>
                    <div className="text-gray-600 dark:text-neutral-400">Clicks</div>
                    <div className="font-medium">{campaign.clicks}</div>
                  </div>
                  <div>
                    <div className="text-gray-600 dark:text-neutral-400">CTR</div>
