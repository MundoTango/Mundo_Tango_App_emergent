        ...
        <CardContent>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            <div className="text-center">
              ...
              <div className="text-sm text-gray-600 dark:text-neutral-600 dark:text-neutral-400">Avg Response Time</div>
            </div>
            <div className="text-center">
        ...
        <CardContent>
          <div className="grid grid-cols-2 gap-4">
            <div className="p-4 bg-gray-50 rounded-lg dark:bg-neutral-800">
              ...
              <div className="text-sm text-gray-600 dark:text-neutral-600 dark:text-neutral-400">95th Percentile</div>
            </div>
            <div className="p-4 bg-gray-50 rounded-lg dark:bg-neutral-800">
              <div className="text-2xl font-bold text-gray-800 dark:text-neutral-200">{metrics.p99Latency}ms</div>
              <div className="text-sm text-gray-600 dark:text-neutral-600 dark:text-neutral-400">99th Percentile</div>
            </div>
          </div>
        </CardContent>
      </Card>
