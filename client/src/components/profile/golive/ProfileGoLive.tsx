        ...
        <CardContent>
          <div className="space-y-3">
            ...
            <div key={index} className="flex items-center justify-between p-3 bg-[var(--color-surface-elevated)] rounded-lg">
                ...
                <div className="flex items-center gap-3">
                  <span className="text-sm text-gray-600 dark:text-gray-300">{region.latency}ms</span>
                  <Badge className={region.status === 'active' ? 'bg-green-100 text-green-800' : 'bg-[var(--color-neutral-100)] text-gray-600 dark:text-gray-300'}>
                    {region.status}
                  </Badge>
                </div>
              </div>
        ...
        <CardContent>
          <div className="space-y-3">
            ...
            <div key={index} className="flex items-center gap-3">
                <div className="w-16 text-sm text-gray-600 dark:text-gray-300">{item.time}</div>
