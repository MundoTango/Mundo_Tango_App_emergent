        ...
        <CardContent>
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
            <div className="text-center p-4 bg-[var(--color-surface)] dark:bg-gray-900/70 rounded-lg">
              ...
              <div className="text-sm text-gray-600 dark:text-gray-300">Adoption Rate</div>
            </div>
            <div className="text-center p-4 bg-[var(--color-surface)] dark:bg-gray-900/70 rounded-lg">
            ...
            <div className="text-center p-4 bg-[var(--color-surface)] dark:bg-gray-900/70 rounded-lg">
              ...
              <div className="text-sm text-gray-600 dark:text-gray-300">Positive Feedback</div>
            </div>
          </div>
        </CardContent>
      </Card>
            ...
            {metrics.featureUsage.map((feature, index) => (
              <div key={index}>
                <div className="flex justify-between mb-2">
                  ...
                  <span className="text-sm text-gray-600 dark:text-gray-300">{feature.usage}%</span>
                </div>
        ...
        <CardContent>
          ...
          <div className="mt-4 space-y-2">
            ...
            <div className="flex items-center justify-between p-3 bg-[var(--color-surface-elevated)] rounded-lg">
              ...
              <Badge className="bg-[var(--color-neutral-100)] text-gray-800 dark:text-gray-100">{metrics.userFeedback[1].count}</Badge>
            </div>
          ...
          <div className="space-y-3">
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <div className="text-sm text-gray-600 dark:text-gray-300">Current usage at 65% - implement onboarding tutorial</div>
              </div>
            </div>
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <div className="text-sm text-gray-600 dark:text-gray-300">Users report friction in the posting flow</div>
              </div>
            </div>
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <div className="text-sm text-gray-600 dark:text-gray-300">Test new features with small user groups first</div>
              </div>
            </div>
          </div>
        </CardContent>
