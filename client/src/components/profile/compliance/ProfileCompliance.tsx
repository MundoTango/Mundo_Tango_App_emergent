      ...
      <Card className="border-amber-200 bg-gradient-to-br from-amber-50/50 to-orange-50/50">
        ...
        <CardContent>
          <div className="text-center mb-6">
            ...
            <div className="text-lg text-gray-600 mt-2 dark:text-neutral-600 dark:text-neutral-400">Overall Compliance Score</div>
          ...
          <div className="grid grid-cols-2 gap-4 text-sm">
            <div>
              <span className="text-gray-600 dark:text-neutral-600 dark:text-neutral-400">Last Audit:</span>
              <div className="font-medium">{metrics.lastAudit.toLocaleDateString()}</div>
            </div>
            <div>
              <span className="text-gray-600 dark:text-neutral-600 dark:text-neutral-400">Next Audit:</span>
          ...
          <div className="space-y-3">
            <div className="flex items-center justify-between p-3 bg-green-50 rounded-lg">
              <div>
                ...
                <div className="text-sm text-gray-600 dark:text-neutral-600 dark:text-neutral-400">Last updated: 30 days ago</div>
              </div>
            ...
            <div className="flex items-center justify-between p-3 bg-green-50 rounded-lg">
              <div>
                ...
                <div className="text-sm text-gray-600 dark:text-neutral-600 dark:text-neutral-400">Last updated: 45 days ago</div>
              </div>
              <Badge className="bg-green-100 text-green-800">Current</Badge>
            </div>
            <div className="flex items-center justify-between p-3 bg-yellow-50 rounded-lg">
              <div>
                ...
                <div className="text-sm text-gray-600 dark:text-neutral-600 dark:text-neutral-400">Review needed in 15 days</div>
              </div>
