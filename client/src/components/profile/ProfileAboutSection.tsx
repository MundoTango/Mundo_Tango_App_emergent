        ...
        <CardContent className="p-6 bg-gradient-to-br from-white via-turquoise-50/20 to-cyan-50/20 space-y-6">
          {user.bio && (
            <div className="glassmorphic-card p-4">
              ...
              <p className="text-gray-700 dark:text-neutral-300">{user.bio}</p>
            </div>
          )}
          ...
          {(user.city || user.country) && (
            <div className="flex items-center gap-2 glassmorphic-card p-4">
              ...
              <span className="text-gray-700 font-medium dark:text-neutral-300">{[user.city, user.state, user.country].filter(Boolean).join(', ')}</span>
            </div>
          )}
                  ...
                  return (
                    ...
                    >
                      ...
                      <div className="flex items-center gap-2">
                        ...
                        <p className="text-sm font-medium text-gray-700 group-hover:text-turquoise-600 transition-colors duration-300 dark:text-neutral-300">
                          {roleDisplayName}
                        </p>
                      </div>
                    </div>
          ...
          <div className="grid grid-cols-2 gap-4">
            {user.leaderLevel !== undefined && user.leaderLevel > 0 && (
              <div className="glassmorphic-card p-4">
                <p className="text-sm text-gray-600 mb-2 dark:text-neutral-400">Leader Level</p>
                <div className="flex items-center gap-2">
            ...
            {user.followerLevel !== undefined && user.followerLevel > 0 && (
              <div className="glassmorphic-card p-4">
                <p className="text-sm text-gray-600 mb-2 dark:text-neutral-400">Follower Level</p>
                <div className="flex items-center gap-2">
                  <div className="w-full bg-gray-200/50 rounded-full h-2.5 overflow-hidden">
                    <div 
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem className="space-y-2">
                      <FormLabel className="text-gray-700 font-semibold text-base flex items-center gap-2 dark:text-neutral-300">
                  ...
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem className="glassmorphic-card p-6 shadow-lg hover:shadow-xl transition-all duration-300 border border-turquoise-200/30">
                        <FormLabel className="text-gray-700 font-semibold flex items-center gap-2 mb-3 dark:text-neutral-300">
                          <User className="w-4 h-4 text-turquoise-500" />
                          Leader Level (0-10)
                        </FormLabel>
                        <FormControl>
        ...
        <div className="space-y-6">
          ...
          <div className="glassmorphic-card p-4">
            ...
            <div className="space-y-3">
              <div>
                <p className="text-sm text-gray-600 mb-1 dark:text-neutral-400">Name</p>
                <p className="font-medium text-gray-800 dark:text-neutral-200">{user.name}</p>
              </div>
              
              {(user.city || user.country) && (
                <div>
                  <p className="text-sm text-gray-600 mb-1 dark:text-neutral-400">Location</p>
                  <div className="flex items-center gap-2">
                    <MapPin className="w-5 h-5 text-turquoise-500" />
                    <span className="text-gray-700 font-medium dark:text-neutral-300">{[user.city, user.state, user.country].filter(Boolean).join(', ')}</span>
                  </div>
          ...
          {user.tangoRoles && (
            <div className="mt-6">
              <div className="mb-4">
                ...
                <p className="text-sm text-gray-600 dark:text-neutral-400">Your roles in the tango community</p>
              </div>
              ...
              <div className="mt-4 p-3 bg-gradient-to-r from-turquoise-50/50 to-cyan-50/50 rounded-lg">
                <p className="text-sm text-gray-600 italic dark:text-neutral-400">
                  {(() => {
          ...
          {user.startedDancingYear && (
            <div className="glassmorphic-card p-4">
              ...
              <div className="flex items-center gap-2">
                ...
                <span className="text-gray-700 font-medium dark:text-neutral-300">Dancing since {user.startedDancingYear} ({new Date().getFullYear() - user.startedDancingYear} years)</span>
              </div>
            </div>
          )}
        </div>
