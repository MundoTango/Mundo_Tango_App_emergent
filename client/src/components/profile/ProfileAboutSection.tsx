          ...
          <div className="flex flex-row items-center justify-between">
            ...
            <div className="flex gap-2">
              ...
              <Button
                ...
                className="bg-gradient-to-r from-turquoise-400 to-cyan-500 text-white hover:shadow-lg hover:scale-105 transition-all duration-300" data-testid="button-bg-gradient-to-r">
