    ...
    <div className="space-y-6">
      ...
      <Card className="glassmorphic-card beautiful-hover">
        ...
        <CardContent className="space-y-4">
          <div>
            <h4 className="font-semibold mb-2">{t('common.property_types')}</h4>
          ...
          <div>
            <h4 className="font-semibold mb-2">{t('common.room_types')}</h4>
            <div className="flex flex-wrap gap-2">
          ...
          <div>
            <h4 className="font-semibold mb-2">{t('common.amenities')}</h4>
            <div className="flex flex-wrap gap-2">
      ...
      <Card className="glassmorphic-card beautiful-hover">
        ...
        <CardContent className="space-y-4">
          <div>
            <h4 className="font-semibold mb-2">{t('common.languages_spoken')}</h4>
            <div className="flex flex-wrap gap-2">
              {profile.languagesSpoken.map((lang) => (
                <Badge key={lang} className="bg-blue-100 dark:bg-blue-900/30 text-blue-800">{lang}</Badge>
              ))}
            </div>
          </div>
          <div>
            <h4 className="font-semibold mb-2">{t('common.travel_interests')}</h4>
            <div className="flex flex-wrap gap-2">
              {profile.travelInterests.map((interest) => (
                <Badge key={interest} className="bg-green-100 dark:bg-green-900/30 text-green-800">{interest}</Badge>
              ))}
            </div>
          </div>
          <div>
            <h4 className="font-semibold mb-2">{t('common.preferred_neighborhoods')}</h4>
            <div className="flex flex-wrap gap-2">
      ...
      <Card className="glassmorphic-card beautiful-hover">
        ...
        <CardContent className="space-y-4">
          <div>
            <h4 className="font-semibold mb-2">{t('common.dietary_restrictions')}</h4>
            {profile.dietaryRestrictions.length > 0 ? (
              ...
              <p className="text-gray-500">{t('common.no_dietary_restrictions_specified')}</p>
            )}
          </div>
          {profile.specialNeeds && (
            <div>
              <h4 className="font-semibold mb-2">{t('common.special_needs')}</h4>
      ...
      <Card className="glassmorphic-card beautiful-hover">
        ...
        <CardContent className="space-y-4">
          <div>
            <h4 className="font-semibold mb-2">{t('common.budget_range')}</h4>
            <p className="text-lg">
              {profile.budgetRange.currency} {profile.budgetRange.min} - {profile.budgetRange.max} / night
            </p>
          </div>
          <div>
            <h4 className="font-semibold mb-2">{t('common.preferred_stay_duration')}</h4>
        ...
        <Card className="glassmorphic-card beautiful-hover">
          ...
          <CardContent>
            <div className="bg-red-50 dark:bg-red-900/20 border border-red-200 rounded-lg p-4">
              <p className="text-sm text-red-700 mb-2">{t('common.this_information_is_private_and_only_shared_with_h')}</p>
              <div className="space-y-2">
                <p><strong>{t('common.name')}</strong> {profile.emergencyContact.name}</p>
                <p><strong>{t('common.phone')}</strong> {profile.emergencyContact.phone}</p>
                <p><strong>{t('common.relationship')}</strong> {profile.emergencyContact.relationship}</p>
              </div>
            </div>
          </CardContent>
        </Card>
