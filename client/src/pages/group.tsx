...
export default function GroupPage() {
  ...
  if (isLoading) {
    return (
      <DashboardLayout>
        <div className="min-h-screen bg-gradient-to-br from-turquoise-50 via-cyan-50 to-blue-50 dark:from-gray-900 dark:via-gray-800 dark:to-gray-900 flex items-center justify-center">
          <div className="text-center">
            ...
            <p className="text-gray-700 dark:text-gray-300 text-lg">Loading group...</p>
          </div>
        </div>
      </DashboardLayout>
    );
