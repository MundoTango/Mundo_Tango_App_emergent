    ...
    <div style={{
      ...
      <div style={{ marginTop: '40px', padding: '20px', backgroundColor: 'white', borderRadius: '10px' }}>
        ...
        <ul style={{ fontSize: '20px', lineHeight: '1.8' }}>
          <li><a href="/" style={{ color: 'blue' }} data-testid="a-element">/ - Home</a></li>
          <li><a href="/moments" style={{ color: 'blue' }} data-testid="a-element">/moments - Moments</a></li>
          <li><a href="/enhanced-timeline" style={{ color: 'blue' }} data-testid="a-element">/enhanced-timeline - Enhanced Timeline V2</a></li>
          <li><a href="/timeline-v2" style={{ color: 'blue' }} data-testid="a-element">/timeline-v2 - Test Route</a></li>
        </ul>
      </div>
    </div>);
