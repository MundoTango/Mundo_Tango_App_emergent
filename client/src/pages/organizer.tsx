      ...
      <div className="max-w-4xl mx-auto p-6">
        <div className="card">
          <div className="text-center py-12">
            ...
            <h1 className="text-3xl font-bold text-black-text-color mb-4 dark:text-white">Organizer Tools Coming Soon</h1>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mt-8">
              <div className="card bg-background-color">
                <div className="p-6 text-center">
                  ...
                  <h3 className="font-semibold text-black-text-color mb-2 dark:text-white">Event Management</h3>
              ...
              <div className="card bg-background-color">
                <div className="p-6 text-center">
                  ...
                  <h3 className="font-semibold text-black-text-color mb-2 dark:text-white">Analytics</h3>
              ...
              <div className="card bg-background-color">
                <div className="p-6 text-center">
                  ...
                  <h3 className="font-semibold text-black-text-color mb-2 dark:text-white">Promotion Tools</h3>
