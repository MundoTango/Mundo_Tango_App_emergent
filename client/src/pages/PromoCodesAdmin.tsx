    ...
    <div className="min-h-screen bg-gradient-to-br from-turquoise-50 via-cyan-50 to-blue-50 py-12">
            ...
            <Table>
                ...
                <TableRow key={promo.id}>
                      <TableCell>
                        ...
                        variant="ghost"
                        size="icon"
                        onClick={() => copyToClipboard(promo.code)} data-testid="button-element">
                    ...
                    <Badge className="bg-[var(--color-neutral-100)] text-[var(--color-text-secondary)]">Inactive</Badge>
                      ...
                      <TableCell>
                        ...
                        variant="ghost"
                        size="icon"
                        onClick={() => handleEdit(promo)} data-testid="button-element">
      ...
      <Dialog open={showCreateDialog} onOpenChange={setShowCreateDialog}>
        <DialogContent className="sm:max-w-md">
          ...
          <div className="space-y-4">
            <div>
              ...
              <Input
                ...
                className="mt-1" data-testid="input-code" />
            ...
            <div className="grid grid-cols-2 gap-4">
              ...
              <div>
                ...
                <Input
                  ...
                  className="mt-1" data-testid="input-value" />
            ...
            <div>
              ...
              <Input
                ...
                className="mt-1" data-testid="input-description" />
            ...
            <div className="grid grid-cols-2 gap-4">
              <div>
                ...
                <Input
                  ...
                  className="mt-1" data-testid="input-validfrom" />
              ...
              <div>
                ...
                <Input
                  ...
                  className="mt-1" data-testid="input-validuntil" />
            ...
            <div>
              ...
              <Input
                ...
                placeholder="100"
                className="mt-1" data-testid="input-usagelimit" />
          ...
          <DialogFooter>
            <Button variant="outline" onClick={() => setShowCreateDialog(false)} data-testid="button-element">
              Cancel
            </Button>
            <Button
