...
export default function ErrorBoundaryPage({ error, resetError }: ErrorBoundaryPageProps) {
  ...
  return (
    <div className="min-h-screen w-full flex items-center justify-center bg-gradient-to-br from-turquoise-50 dark:from-turquoise-900/30 via-cyan-50 to-blue-50 p-4">
        ...
        <CardContent className="space-y-6">
            ...
            <div className="p-4 bg-red-50 border border-red-200 rounded-lg">
              ...
              {process.env.NODE_ENV === 'development' && error.stack && (
                <details className="mt-2">
                  ...
                  <pre className="mt-2 text-xs text-red-600 dark:text-red-400 overflow-auto max-h-40 p-2 bg-red-100 rounded">
                    {error.stack}
                  </pre>
                </details>
              )}
          ...
          <div className="grid gap-3">
            ...
            <Button
              ...
              variant="outline"
              className="w-full border-turquoise-200 dark:border-turquoise-800/40 hover:bg-turquoise-50"
            >
            ...
            >
              {reportSent ? (
                <>
                  <AlertTriangle className="w-4 h-4 mr-2 text-green-600 dark:text-green-400" />
                  Error Report Sent
                </>
              ) : (
                <>
          ...
          <div className="border-t pt-6">
            <h4 className="font-semibold mb-3 flex items-center gap-2">
              <FileQuestion className="w-5 h-5 text-turquoise-600 dark:text-turquoise-400" />
              Common Solutions
            </h4>
            <ul className="space-y-2 text-sm text-gray-600 dark:text-gray-400">
              <li className="flex items-start gap-2">
                <span className="text-turquoise-600 dark:text-turquoise-400 mt-0.5">•</span>
          ...
          <div className="text-center pt-4 border-t">
            <p className="text-sm text-gray-500">
              ...
              <a href="mailto:support@mundotango.life" className="text-turquoise-600 dark:text-turquoise-400 hover:underline">
