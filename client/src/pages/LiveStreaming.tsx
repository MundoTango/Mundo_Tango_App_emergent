  ...
  return (
    <div className="container mx-auto p-4 max-w-7xl" data-testid="live-streaming-page">
      <div className="flex justify-between items-center mb-6">
        <div>
          <h1 className="text-3xl font-bold text-gray-900 dark:text-white dark:text-white">Live Streaming</h1>
      ...
      {isStreaming && (
        <div className="fixed inset-0 z-50 bg-black">
          <div className="h-full flex">
            ...
            {/* Chat Sidebar */}
            <div className="w-80 bg-white dark:bg-gray-900 dark:bg-gray-900 border-l">
