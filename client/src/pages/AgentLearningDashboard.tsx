    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 p-6">
      <div className="max-w-7xl mx-auto space-y-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
          <Card className="bg-white dark:bg-gray-900/10 border-purple-500/30 backdrop-blur">
          ...
          <CardContent>
            <div className="space-y-4 max-h-[600px] overflow-y-auto">
              {patterns?.map((pattern) => (
                <div
                  key={pattern.id}
                  className="bg-white dark:bg-gray-900/5 rounded-lg p-4 border border-purple-500/20 hover:border-purple-400/40 transition-colors"
