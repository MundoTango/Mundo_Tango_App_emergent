      ...
      <div className="max-w-7xl mx-auto px-4 py-6">
        ...
        <div className="mb-8">
          <div className="flex items-center justify-between mb-6">
            <div>
              <h1 className="text-3xl font-bold text-[var(--color-text)] dark:text-white">Global Tango Statistics</h1>
              <p className="text-gray-600 dark:text-gray-300 mt-2">Comprehensive overview of the worldwide tango community</p>
            </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-6 gap-4 mb-8">
            <Card className="p-4 bg-gradient-to-r from-blue-50 to-indigo-50">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-2xl font-bold text-[var(--color-text)] dark:text-white">{formatNumber(mockStats.totalUsers)}</p>
            ...
            <Card className="p-4 bg-gradient-to-r from-green-50 to-emerald-50">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-2xl font-bold text-[var(--color-text)] dark:text-white">{formatNumber(mockStats.activeUsers)}</p>
                  <p className="text-xs text-green-600 flex items-center mt-1">
                    <ArrowUp className="w-3 h-3 mr-1" />
                    +8.7%
                  </p>
            ...
            <Card className="p-4 bg-gradient-to-r from-purple-50 to-violet-50">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-2xl font-bold text-[var(--color-text)] dark:text-white">{formatNumber(mockStats.totalEvents)}</p>
                  <p className="text-xs text-green-600 flex items-center mt-1">
                    <ArrowUp className="w-3 h-3 mr-1" />
                    +15.4%
                  </p>
            ...
            <Card className="p-4 bg-gradient-to-r from-pink-50 to-rose-50">
              <div className="flex items-center justify-between">
                <div>
                  <p className="text-sm text-gray-600 dark:text-gray-300">Communities</p>
                  <p className="text-2xl font-bold text-[var(--color-text)] dark:text-white">{formatNumber(mockStats.totalCommunities)}</p>
                  <p className="text-xs text-green-600 flex items-center mt-1">
                    <ArrowUp className="w-3 h-3 mr-1" />
                    +6.2%
                  </p>
            ...
            <Card className="p-4 bg-gradient-to-r from-yellow-50 to-amber-50">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-2xl font-bold text-[var(--color-text)] dark:text-white">{formatNumber(mockStats.totalPosts)}</p>
                  <p className="text-xs text-green-600 flex items-center mt-1">
                    <ArrowUp className="w-3 h-3 mr-1" />
                    +23.8%
                  </p>
            ...
            <Card className="p-4 bg-gradient-to-r from-cyan-50 to-teal-50">
              <div className="flex items-center justify-between">
                <div>
                  <p className="text-sm text-gray-600 dark:text-gray-300">Friendships</p>
                  <p className="text-2xl font-bold text-[var(--color-text)] dark:text-white">{formatNumber(mockStats.totalFriendships)}</p>
                  <p className="text-xs text-green-600 flex items-center mt-1">
                    <ArrowUp className="w-3 h-3 mr-1" />
                    +18.5%
                  </p>
        ...
        <Tabs defaultValue="overview" className="space-y-6">
                ...
                <div className="space-y-3">
                  ...
                  <div key={month.month} className="flex items-center justify-between">
                      ...
                      <div className="flex items-center gap-3">
                        ...
                        <span className="text-sm font-medium text-[var(--color-text)] dark:text-white w-12 text-right">
                          {month.newUsers}
                        </span>
                      </div>
                    </div>
              ...
              <Card className="p-6">
                ...
                <div className="space-y-3">
                  ...
                  <div key={role.role} className="flex items-center justify-between">
                      <span className="text-sm text-gray-600 dark:text-gray-300">{role.role}</span>
                      <div className="flex items-center gap-3">
                        <div className="w-32 bg-gray-200 dark:bg-gray-700 rounded-full h-2">
                          <div
            ...
            <Card className="p-6">
              ...
              <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                <div className="text-center p-4 bg-[var(--color-surface-elevated)] rounded-lg">
                  ...
                  <p className="text-sm text-gray-600 dark:text-gray-300 mt-1">Avg Posts/User</p>
                </div>
                <div className="text-center p-4 bg-[var(--color-surface-elevated)] rounded-lg">
                  <p className="text-2xl font-bold text-purple-600">{mockStats.engagementMetrics.avgEventsAttended}</p>
                  <p className="text-sm text-gray-600 dark:text-gray-300 mt-1">Avg Events/User</p>
                </div>
                <div className="text-center p-4 bg-[var(--color-surface-elevated)] rounded-lg">
                  <p className="text-2xl font-bold text-pink-600">{mockStats.engagementMetrics.avgFriendsPerUser}</p>
                  <p className="text-sm text-gray-600 dark:text-gray-300 mt-1">Avg Friends/User</p>
                </div>
                <div className="text-center p-4 bg-[var(--color-surface-elevated)] rounded-lg">
                  <p className="text-2xl font-bold text-green-600">{mockStats.engagementMetrics.activePercentage}%</p>
                  <p className="text-sm text-gray-600 dark:text-gray-300 mt-1">Active Users</p>
                </div>
              </div>
            </Card>
          </TabsContent>
          ...
          <TabsContent value="cities" className="space-y-6">
            <Card className="p-6">
              ...
              <div className="space-y-4">
                ...
                <div key={city.city} className="flex items-center justify-between p-4 bg-[var(--color-surface-elevated)] rounded-lg">
                    ...
                    'bg-gradient-to-r from-indigo-400 to-purple-400'}`}>
                      ...
                      <div>
                        <p className="font-semibold text-[var(--color-text)] dark:text-white">{city.city}</p>
                    ...
                    <div className="text-right">
                      ...
                      <p className="text-xs text-gray-600 dark:text-gray-300">of total users</p>
                    </div>
                  </div>
                )}
              </div>
          ...
          <TabsContent value="dancers" className="space-y-6">
            <Card className="p-6">
              ...
              <div className="space-y-4">
                ...
                <div key={dancer.username} className="flex items-center justify-between p-4 bg-[var(--color-surface-elevated)] rounded-lg">
                    <div className="flex items-center gap-4">
                      <div className={`w-10 h-10 rounded-full flex items-center justify-center text-white font-bold
                        ${index === 0 ? 'bg-gradient-to-r from-yellow-400 to-amber-400' :
                    index === 1 ? 'bg-gradient-to-r from-gray-400 to-gray-500' :
                    ...
                    'bg-gradient-to-r from-indigo-400 to-purple-400'}`}>
                      ...
                      <div>
                        <p className="font-semibold text-[var(--color-text)] dark:text-white">{dancer.name}</p>
                        <p className="text-sm text-gray-600 dark:text-gray-300">@{dancer.username}</p>
          ...
          <TabsContent value="trends" className="space-y-6">
            <Card className="p-6">
              ...
              <div className="space-y-4">
                ...
                <div key={month.month} className="flex items-center justify-between">
                    <span className="text-sm font-medium text-[var(--color-text-secondary)] w-12">{month.month}</span>
          ...
          <TabsContent value="engagement" className="space-y-6">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
              <Card className="p-6">
                <h3 className="text-lg font-semibold text-[var(--color-text)] dark:text-white mb-4">Activity Patterns</h3>
                <div className="space-y-4">
                  <div className="flex items-center justify-between p-3 bg-indigo-50 rounded-lg">
                    <div className="flex items-center gap-3">
                      <Clock className="w-5 h-5 text-indigo-600" />
                      <span className="text-sm font-medium text-[var(--color-text-secondary)]">Peak Activity</span>
                    </div>
                  ...
                  <div className="flex items-center justify-between p-3 bg-purple-50 rounded-lg">
                    <div className="flex items-center gap-3">
                      ...
                      <span className="text-sm font-medium text-[var(--color-text-secondary)]">Most Active Day</span>
                    </div>
                  ...
                  <div className="flex items-center justify-between p-3 bg-pink-50 rounded-lg">
                    <div className="flex items-center gap-3">
                      ...
                      <span className="text-sm font-medium text-[var(--color-text-secondary)]">Avg Session</span>
                    </div>
              ...
              <Card className="p-6">
                <h3 className="text-lg font-semibold text-[var(--color-text)] dark:text-white mb-4">Content Performance</h3>
                <div className="space-y-4">
                  <div className="flex items-center justify-between p-3 bg-green-50 rounded-lg">
                    <div className="flex items-center gap-3">
                      <Heart className="w-5 h-5 text-green-600" />
                      <span className="text-sm font-medium text-[var(--color-text-secondary)]">Avg Likes/Post</span>
                    </div>
                  ...
                  <div className="flex items-center justify-between p-3 bg-blue-50 rounded-lg">
                    <div className="flex items-center gap-3">
                      ...
                      <span className="text-sm font-medium text-[var(--color-text-secondary)]">Avg Event Attendance</span>
                    </div>
                  ...
                  <div className="flex items-center justify-between p-3 bg-amber-50 rounded-lg">
                    <div className="flex items-center gap-3">
                      ...
                      <span className="text-sm font-medium text-[var(--color-text-secondary)]">User Satisfaction</span>
                    </div>
