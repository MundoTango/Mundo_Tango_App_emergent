...
const MemoriesDebug = lazy(() => import("@/pages/MemoriesDebug"));
    ...
    <WouterRouter>
      <ErrorBoundary>
        <Suspense fallback={<LoadingFallback />}>
          ...
          <Route path="/memories-debug">
            <Suspense fallback={<LoadingFallback message="Loading debug..." />}>
              <MemoriesDebug />
            </Suspense>
          </Route>

          <Route path="/memories-test">
