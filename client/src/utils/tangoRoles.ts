...
export const TANGO_ROLES: TangoRole[] = [
  ...
  { id: 'dancer_leader', name: 'Leader', emoji: '🕺', description: 'Dancer: Leader', category: 'dance', priority: 2 },
  { id: 'dancer_follower', name: 'Follower', emoji: '💃', description: 'Dancer: Follower', category: 'dance', priority: 3 },
  { id: 'dancer_switch', name: 'Both', emoji: '🕺💃', description: 'Dancer: Both roles', category: 'dance', priority: 4 },
